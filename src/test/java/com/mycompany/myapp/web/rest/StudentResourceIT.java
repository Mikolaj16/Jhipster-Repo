...
public class StudentResourceIT {
    ...
    private static final String DEFAULT_INDEX_NO = "AAAAAAAAAA";
    private static final String UPDATED_INDEX_NO = "BBBBBBBBBB";
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getModel()).isEqualTo(DEFAULT_MODEL);
        assertThat(testStudent.getLastName()).isEqualTo(DEFAULT_LAST_NAME);
        assertThat(testStudent.getIndexNo()).isEqualTo(DEFAULT_INDEX_NO);
    }
    ...
    public void getAllStudents() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].indexNo").value(hasItem(DEFAULT_INDEX_NO)));
    }
    ...
    public void getStudent() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students/{id}", student.getId()))
            ...
            .andExpect(jsonPath("$.indexNo").value(DEFAULT_INDEX_NO));
    }
    ...
    public void updateStudent() throws Exception {
        ...
        Student testStudent = studentList.get(studentList.size() - 1);
        assertThat(testStudent.getModel()).isEqualTo(UPDATED_MODEL);
        assertThat(testStudent.getLastName()).isEqualTo(UPDATED_LAST_NAME);
        assertThat(testStudent.getIndexNo()).isEqualTo(UPDATED_INDEX_NO);
    }
